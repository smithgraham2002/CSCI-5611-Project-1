//Ball ball collision, take from slides
...
//Ball circle collision, standard fair
...
//Ball wall collision, standard fair
void ballWall(int i){
...
//ball line collision, similar to ball wall with some aditional checks
